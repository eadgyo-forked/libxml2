...
import (
	...
	"github.com/eadgyo-forked/libxml2"
	"github.com/eadgyo-forked/libxml2/dom"
	"github.com/eadgyo-forked/libxml2/xpath"
...
type Foo struct {
	XMLName xml.Name `xml:"https://github.com/eadgyo-forked/libxml2/foo foo:foo"`
	Field1  string
...
func BenchmarkLibxml2DOM(b *testing.B) {
	var buf bytes.Buffer
	const nsuri = `https://github.com/eadgyo-forked/libxml2/foo`
	f := Foo{
		Field1: "Hello, World!",
		Field2: "Hello, Attribute!",
	}
