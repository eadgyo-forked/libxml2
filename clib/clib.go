...
/*
#cgo LDFLAGS:-static -lxml2 -lpthread -licuuc -lstdc++ -licudata -ldl -lz -lm -llzma
...
import (
	...
	"github.com/eadgyo-forked/libxml2/internal/debug"
	"github.com/eadgyo-forked/libxml2/internal/option"
